...
echo "    net localgroup Administrators `"${ud_domain}\${ud_machine_smb_local_admin_group}`" /add" >> $installScriptPath
echo "    net localgroup Administrators `"${ud_domain}\${ud_machine_rdp_local_admin_group}`" /add" >> $installScriptPath
